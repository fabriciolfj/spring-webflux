...
public class FluxAndMonoBackPressureTest {
    ...
    public void backPressure() {
        Flux<Integer> finiteFlux = Flux.range(11, 23)
                .log();

        finiteFlux.subscribe(element -> System.out.println("Element is: " + element)
                , e -> System.err.println("Exception is: " + e)
                , () -> System.out.println("Done")
                ,(subscription -> subscription.request(3)) // estou requerendo o numero de eventos
        );
    }
    ...
    @Test
    public void customized_backPressure_cancel() {
        Flux<Integer> finiteFlux = Flux.range(1, 10)
                .log();
